...
if (module.exports.__esModule) module.exports = module.exports.default
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_vm._m(0),_vm._v(" "),_c('div',{staticClass:"row top-xs"},[_c('div',{staticClass:"col-xs-8 col-xs-offset-2"},[_c('mu-list',[_c('mu-sub-header',[_vm._v("Projeção atual")]),_vm._v(" "),_c('mu-list-item',{directives:[{name:"show",rawName:"v-show",value:(_vm.globalstore.usuario && !_vm.globalstore.usuario.projecao),expression:"globalstore.usuario && !globalstore.usuario.projecao"}],attrs:{"title":"Parece que você não tem uma projeção ainda!"}}),_vm._v(" "),_vm._l((_vm.globalstore.usuario.projecao),function(proj){return _c('mu-list-item',{attrs:{"title":proj.categoria.nome,"describeText":'$ ' + proj.montante}},[(proj.categoria.tipo == 'Saída')?_c('mu-icon',{staticClass:"r",attrs:{"value":"monetization_on"},slot:"left"}):_vm._e(),_vm._v(" "),(proj.categoria.tipo == 'Entrada')?_c('mu-icon',{staticClass:"g",attrs:{"value":"monetization_on"},slot:"left"}):_vm._e(),_vm._v(" "),_c('mu-icon',{attrs:{"value":"indeterminate_check_box"},on:{"click":function($event){_vm.removecategoria(proj)}},slot:"right"})],1)})],2),_vm._v(" "),_c('div',[_c('mu-select-field',{attrs:{"label":"Categoria","fullWidth":""},model:{value:(_vm.catsel),callback:function ($$v) {_vm.catsel=$$v},expression:"catsel"}},_vm._l((_vm.globalstore.categorias),function(cat){return _c('mu-menu-item',{key:cat.nome,attrs:{"value":cat,"title":'[' + cat.tipo + '] ' + cat.nome}})})),_vm._v(" "),_c('mu-text-field',{attrs:{"label":"Montante","type":"number","labelFloat":"","fullWidth":""},model:{value:(_vm.montante),callback:function ($$v) {_vm.montante=$$v},expression:"montante"}}),_vm._v(" "),_c('mu-raised-button',{attrs:{"label":"Adicionar categoria","primary":"","icon":"add_box","fullWidth":""},on:{"click":_vm.addcategoria}}),_vm._v(" "),_c('br'),_vm._v(" "),_c('br'),_vm._v(" "),_c('br')],1)],1)])])}
...
appInit();
},{"./components/globalstore":11,"./features/S0001-login/login.vue":12,"./features/S0002-cadastro/cadastro.vue":13,"./features/S0003-menu/menu.vue":14,"./features/S0005-categorias/categorias.vue":15,"./features/S0006-projecoes/projecoes.vue":16,"./features/S0007-lancamento/lancamento.vue":17,"./main.css":18,"muse-ui":6,"vue":9,"vue-router":8}]},{},[19]);
