...
},{"charenc":3,"crypt":6,"is-buffer":7}],9:[function(require,module,exports){
//! moment.js
//! version : 2.18.1
...
},{"vue":13}],11:[function(require,module,exports){
...
module.exports = function (_) {
  return {
    formatDisplay: function formatDisplay(d) {
      return moment(d).format("DD [de] MMMM");
    },
    formatMonth: function formatMonth(d) {
      return moment(d).format("MMMM");
    },
    getWeekDayArray: function getWeekDayArray() {
      return ["S", "T", "Q", "Q", "S", "S", "D"];
    }
  };
};

},{"moment":9}],16:[function(require,module,exports){
"use strict";
...
var glob = {
  loadcontext: function loadcontext() {
    var data = localStorage.getItem("red-line");
    if (data) {
    ...
    } else glob.initcontext();
  },
  savecontext: function savecontext() {
    // sync usuario logado com o que tem no cadastro
    if (glob.usuario) {
      glob.usuarios = glob.usuarios.filter(function (e) {
        return e.email != glob.usuario.email;
      });
  ...
  initcontext: function initcontext() {
    glob.usuarios = [];
    glob.categorias = [{ nome: "Alimentação", tipo: "Saída" }, { nome: "Transporte", tipo: "Saída" }, { nome: "Vestuário", tipo: "Saída" }, { nome: "Moradia", tipo: "Saída" }, { nome: "Lazer", tipo: "Saída" }, { nome: "Ganhos", tipo: "Entrada" }];
    console.log("context created");
    glob.savecontext();
  },
  existe: function existe(usuario) {
    return new Promise(function (resolve, reject) {
      if (!usuario) reject("Usuário não encontrado");
      var u = glob.usuarios.filter(function (e) {
        return e.email == usuario.email;
      });
      if (u.length > 0) resolve(u);else reject("Usuário não encontrado");
    });
  },
  autentica: function autentica(usuario) {
    return new Promise(function (resolve, reject) {
      glob.usuario = glob.usuarios.filter(function (e) {
        if (e.email == usuario.email && e.senha == md5(usuario.senha)) return e;
      })[0];
      Vue.set(glob, "usuario", glob.usuario);
      glob.savecontext();
      if (glob.usuario) resolve(glob.usuario);else reject("Usuario ou senha incorretos");
    });
  },
  cadastra: function cadastra(usuario) {
    return new Promise(function (resolve, reject) {
      if (!usuario.email) {
      ...
      glob.existe(usuario).then(function (_) {
...
},{"md5":8,"vue":13}],17:[function(require,module,exports){
;(function(){
"use strict";
...
module.exports = {
  ...
  methods: {
    addlancamento: function addlancamento() {
      if (!this.globalstore.usuario.lancamentos) Vue.set(this.globalstore.usuario, "lancamentos", []);
      this.globalstore.usuario.lancamentos.push(JSON.parse((0, _stringify2.default)(this.lancamento)));

      this.globalstore.savecontext();
      alert("Lançamento Salvo!");
      this.lancamento = this.newlancamento();
    },
    newlancamento: function newlancamento() {
      return {
...
module.exports = {
  ...
  computed: {
    parcial: function parcial() {
      var p = 0;
      var u = this.globalstore.usuario;
      u.lancamentos.map(function (e) {
        if (e.categoria.tipo == "Entrada") p += parseInt(e.valor);else p -= parseInt(e.valor);
      });
      return p;
    }
  }
...
module.exports = {
  name: "Login",
  created: function created() {
    if (globalstore.usuario) this.initredir();
  },
  data: function data() {
    return {
      globalstore: globalstore,
  ...
  methods: {
    dologin: function dologin() {
      ...
      globalstore.existe(this.usuario).then(function (_) {
        return globalstore.autentica(_this.usuario);
      }).then(function (_) {
        _this.initredir();
      }).catch(function (e) {
        console.log(e);
    ...
    initredir: function initredir() {
      if (!globalstore.usuario.projecao) window.location.href = "#/projecoes";else window.location.href = "#/lancamentos";
    }
  }
};
})()
...
},{"../../components/globalstore":16}],20:[function(require,module,exports){
;(function(){
"use strict";
...
module.exports = {
  ...
  methods: {
    docadastro: function docadastro() {
      globalstore.cadastra(this.usuario).then(function (_) {
...
},{"../../components/globalstore":16}],21:[function(require,module,exports){
...
module.exports = {
  ...
  methods: {
    ...
    confirm: function confirm(msg, cbconfirm) {
      this.txtconfirm = msg;
    ...
    cbconfirm: function cbconfirm(yesno) {
    ...
    sair: function sair() {
      ...
      confirm("Vai mesmo sair?", function (okmaybe) {
        if ("yes" == okmaybe) {
          _this.globalstore.usuario = null;
...
},{"../../components/globalstore":16,"vueify/lib/insert-css":14}],22:[function(require,module,exports){
;(function(){
"use strict";
...
module.exports = {
  ...
  computed: {
    semlancamentos: function semlancamentos() {
...
},{"../../components/globalstore":16}],23:[function(require,module,exports){
;(function(){
"use strict";
...
module.exports = {
  ...
  methods: {
    faznovacat: function faznovacat() {
      return {
        nome: "",
        tipo: "Saída"
      };
    },
    removecategoria: function removecategoria(c) {
      var _this = this;

      confirm("Deseja realmente remover esta categoria?", function (yn) {
        if ("yes" == yn) {
          _this.globalstore.categorias = _this.globalstore.categorias.filter(function (e) {
            return e != c;
          });
          _this.globalstore.savecontext();
        }
    ...
    criacategoria: function criacategoria() {
...
if (module.exports.__esModule) module.exports = module.exports.default
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_vm._m(0),_vm._v(" "),_c('div',{staticClass:"row top-xs"},[_c('div',{staticClass:"col-xs-8 col-xs-offset-2"},[_c('mu-list',[_c('mu-sub-header',[_vm._v("Categorias para compor projeções")]),_vm._v(" "),_vm._l((_vm.globalstore.categorias),function(cat){return _c('mu-list-item',{key:cat.nome,attrs:{"title":cat.nome}},[(cat.tipo == 'Saída')?_c('mu-icon',{staticClass:"r",attrs:{"value":"monetization_on"},slot:"left"}):_vm._e(),_vm._v(" "),(cat.tipo == 'Entrada')?_c('mu-icon',{staticClass:"g",attrs:{"value":"monetization_on"},slot:"left"}):_vm._e(),_vm._v(" "),_c('mu-icon',{attrs:{"value":"indeterminate_check_box"},on:{"click":function($event){_vm.removecategoria(cat)}},slot:"right"})],1)})],2),_vm._v(" "),_c('form',{on:{"submit":function($event){$event.preventDefault();_vm.criacategoria($event)}}},[_c('mu-select-field',{attrs:{"label":"Tipo","fullWidth":""},model:{value:(_vm.novacat.tipo),callback:function ($$v) {_vm.novacat.tipo=$$v},expression:"novacat.tipo"}},[_c('mu-menu-item',{attrs:{"value":"Entrada","title":"Entrada"}}),_vm._v(" "),_c('mu-menu-item',{attrs:{"value":"Saída","title":"Saída"}})],1),_vm._v(" "),_c('mu-text-field',{attrs:{"label":"Nova categoria","labelFloat":"","fullWidth":""},model:{value:(_vm.novacat.nome),callback:function ($$v) {_vm.novacat.nome=$$v},expression:"novacat.nome"}}),_vm._v(" "),_c('mu-raised-button',{attrs:{"label":"Criar categoria","icon":"add_box","type":"submit","primary":"","fullWidth":""}}),_vm._v(" "),_c('br'),_vm._v(" "),_c('br'),_vm._v(" "),_c('br')],1)],1)])])}
...
},{"../../components/globalstore":16}],24:[function(require,module,exports){
;(function(){
"use strict";
...
module.exports = {
  ...
  methods: {
    addcategoria: function addcategoria() {
      if (!this.globalstore.usuario.projecao) Vue.set(this.globalstore.usuario, "projecao", []);
    ...
    removecategoria: function removecategoria(c) {
      this.globalstore.usuario.projecao = this.globalstore.usuario.projecao.filter(function (e) {
        return e != c;
      });
      this.globalstore.savecontext();
    }
...
},{"../../components/globalstore":16,"vue":13}],25:[function(require,module,exports){
;(function(){
"use strict";
...
},{"../../components/globalstore":16,"moment":9,"vue":13}],26:[function(require,module,exports){
...
},{"browserify-css":2}],27:[function(require,module,exports){
"use strict";
...
var router = new VueRouter({
  routes: [{ path: '/', redirect: '/login' }, { path: '/login', component: require("./features/S0001-login/login.vue") }, { path: '/cadastro', component: require("./features/S0002-cadastro/cadastro.vue") }, { path: '/relatorios', component: require("./features/S0004-relatorios/relatorios.vue") }, { path: '/categorias', component: require("./features/S0005-categorias/categorias.vue") }, { path: '/projecoes', component: require("./features/S0006-projecoes/projecoes.vue") }, { path: '/lancamentos', component: require("./features/S0007-lancamento/lancamento.vue") }]
});

router.beforeEach(function (to, from, next) {
  if (to.path == "/login" || to.path == "/cadastro") next();else if (globalstore.usuario) next();else next("/login");
});
...
var appInit = function appInit() {
  return new Vue({
    ...
    render: function render(r) {
      return r(require("./features/S0003-menu/menu.vue"));
    }
  });
};
...
},{"./components/globalstore":16,"./components/novo-lancamento.vue":17,"./components/saldo-parcial.vue":18,"./features/S0001-login/login.vue":19,"./features/S0002-cadastro/cadastro.vue":20,"./features/S0003-menu/menu.vue":21,"./features/S0004-relatorios/relatorios.vue":22,"./features/S0005-categorias/categorias.vue":23,"./features/S0006-projecoes/projecoes.vue":24,"./features/S0007-lancamento/lancamento.vue":25,"./main.css":26,"muse-ui":10,"vue":13,"vue-router":12}]},{},[27]);
